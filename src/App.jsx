      ...
      <main className="flex-grow">
        ...
        >
          ...
          <div className="slider-nav-container">
            <button onClick={handlePrev} className="slider-nav-button">❮</button>
            <button onClick={handleNext} className="slider-nav-button">❯</button>
          </div>
        </section>
        ...
        <section id="wedding-video" className="p-8 bg-white text-center">
          <h2 className="text-3xl text-pink-700 font-semibold mb-6">Wedding Video</h2>
